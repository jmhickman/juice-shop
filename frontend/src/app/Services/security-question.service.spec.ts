...
describe('SecurityQuestionService', () => {
    ...
    it('should get security question by user email directly from the rest api', () => {
        ...
        const req = httpMock.expectOne('http://localhost:3000/shop/auth/recovery-question?email=x@y.z')
    ...
    it('should handle error when getting security question by user email', () => {
        ...
        const req = httpMock.expectOne('http://localhost:3000/shop/auth/recovery-question?email=e@x.ample')
